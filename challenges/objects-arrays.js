...
const universities = [];
graduates.map(function(names){
universities.push(names.first_name)
})
...
const uni = [];
graduates.forEach(function (unv){
  uni.push(`${unv.university}`)
});
console.log(uni);
...
zooAnimals.reduce( function(add,total){
return total.population + add;
},0);
